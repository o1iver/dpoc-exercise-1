function [optCost, optPath] = sp_lca(P,startNode,termNode)
% [optCost, optPath] = sp_lca(P,startNode,termNode)
% 
% Function for solving shortest path problem using the Label Correcting
% Algorithm.  For selecting the nodes from the candidate list OPEN, use
% the depth-first method.
% Solution according to Bertsekas Sec. 2.3.1.
%
% Input:
